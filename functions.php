...
//new table for save images name
...
add_action("wp_dashboard_setup", 'slider_table' );
...
function add_my_slider_widgets(){
    
    wp_add_dashboard_widget('my_slider_widgets', 'Slider Widgets', 'my_slider_widget');
    
}
add_action('wp_slider','my_slider_widget');
add_action('wp_dashboard_setup','add_my_slider_widgets');
function srtarh_scripts(){
    wp_enqueue_script('slider', get_template_directory_uri().'/js/slider.js');
}
add_action('admin_enqueue_scripts', 'srtarh_scripts');
